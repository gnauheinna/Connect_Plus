...
export default function RachelFeaturedScreen({ navigation }) {
          ...
          <View style={styles.titleAndSaveButtonContainer}>
            <View style={styles.postTitleContainer}>
              ...
              <Text style={styles.postTitle}>
                Volunteering in Florida Natural Reserve - Alternative Service
                Break
              </Text>
            </View>
          </View>
        ...
        <View style={styles.postContentContainer}>
          <View style={styles.postContentMainContainer}>
            ...
            <View style={styles.individualStep}>
              <View style={styles.regularContentContainer}>
                <Text style={styles.regularContentText}>
                  This March, I had the incredible opportunity to participate in
            ...
            <View style={styles.individualStep}>
              ...
              <View style={styles.regularContentContainer}>
                <Text style={styles.regularContentText}>
                  On the day of departure, the morning began early at 5 am as we
              ...
              <View style={styles.regularContentContainer}>
                <Text style={styles.regularContentText}>
                  For the first four days, we volunteered from 9 am to 4 pm with
            ...
            <View style={styles.individualStep}>
              ...
              <View style={styles.regularContentContainer}>
                <Text style={styles.regularContentText}>
                  One of the challenges I faced was adapting to the living
            ...
            <View style={styles.individualStep}>
              ...
              <View style={styles.regularContentContainer}>
                <Text style={styles.regularContentText}>
                  This experience was eye-opening, fun, challenging, and
