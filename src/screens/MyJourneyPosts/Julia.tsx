...
export default function JuliaScreen({ navigation }) {
              ...
              <View style={styles.regularContentContainer}>
                ...
                <View style={styles.indentedContentContainer}>
                  ...
                  <Text style={styles.regularContentText}>
                    ...
                    You can already go off-campus as a first-year. There is also
                    a work-study award available if you are a U.S. citizen that
                    automatically deposits your salary into your Student
                    Account.
                  </Text>
                </View>
                ...
                <View style={styles.indentedContentContainer}>
                  <Text style={styles.regularContentText}>
                    ...
                    : You can find a list of On/Off-campus Part-time positions
                    or Quick Jobs (one-time jobs) listed under the “Job and
                  ...
                  <Text style={styles.regularContentText}>
                    ...
                    <Text style={styles.regularContentTextBolded}>
                      BU’s Student Employment Office{" "}
                    </Text>
                    has an official Instagram page. They post very frequently
                    about available positions and job-tips for students
                    on/off-campus.
                  </Text>
                  <Text style={styles.regularContentText}>
                    • Ask around:{" "}
                    ...
                    interested in and they can let you know if they are
                    recruiting.
                  </Text>
                </View>

                <Text style={styles.regularContentText}>3. Apply</Text>
                <View style={styles.indentedContentContainer}>
                  <Text style={styles.regularContentText}>
                    • Resume, Cover letter, and Application form: Most Quick
                    Jobs don’t require any of these, but Part-time Jobs usually
                    require a Resume. Use the{" "}
                    <Text style={styles.regularContentTextBolded}>
                  ...
                  <Text style={styles.regularContentText}>
                    ...
                    <Text style={styles.regularContentTextBolded}>
                      just be yourself, be sincere , and the interviewer will
                      notice that!
                    </Text>
                  </Text>
                </View>
                ...
                <View style={styles.indentedContentContainer}>
                  <Text style={styles.regularContentText}>
                    •{" "}
                    <Text style={styles.regularContentTextBolded}>
                      Enter your hours on the Student Employment Portal{" "}
                    </Text>
                    : Once you’re officially hired and working, you will be
                    entering your hours yourself every week. The period ends on
                    Thursday (so you will need to enter future hours that you
                    will be working after Thursday that week) and your
                    supervisor will review your hours after you have submitted
                    them.
                  </Text>
                  <Text style={styles.regularContentText}>
                    • Direct Deposit: You can also{" "}
                    <Text style={styles.regularContentTextBolded}>
                      set up Direct Deposit{" "}
                    </Text>
                    to have your paycheck directly deposited into your account
                    without having to get a physical check every week! This
                    would{" "}
                    <Text style={styles.regularContentTextBolded}>
                      require you to obtain a Social Security Card{" "}
                    </Text>
                    that you can apply for once you are hired if you are
                    employed for the first time in the U.S.!
                  </Text>
                </View>
              </View>
            </View>
