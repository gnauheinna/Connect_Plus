...
export default function ShatevaScreen({ navigation }) {
            ...
            <View style={styles.individualStep}>
              ...
              <View style={styles.regularContentContainer}>
                <Text style={styles.regularContentText}>
                  ...
                  meshed well. The project itself was also{" "}
                  <Text style={styles.regularContentTextBolded}>
                    the perfect combination of challenging and interesting.{" "}
                  </Text>
                  I got to learn a new programming language and use it to build
                  an interactive data report, and I enjoyed every minute of it.
                  I got to utilize all of the skills I developed over the years
                  and put my all into this project. It was genuinely the first
