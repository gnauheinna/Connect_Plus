...
export default function NanaScreen({ navigation }) {
          ...
          <View style={styles.postContentMainContainer}>
            ...
            <View style={styles.individualStep}>
              <View style={styles.regularContentContainer}>
                ...
                <Text style={styles.regularContentText}>
                  ...
                  As much as possible, tap into your community and learn from
                  them.”
                </Text>
              </View>
            </View>
            ...
            <View style={styles.individualStep}>
              ...
              <View style={styles.regularContentContainer}>
                <Text style={styles.regularContentTextBolded}>
                  Q: What does first-gen mean to you?
                </Text>
                <Text style={styles.regularContentText}>
                ...
                <Text style={styles.regularContentText}>
                  <Text style={styles.underlinedText}>
                    Being first-gen is powerful.{" "}
                  </Text>
                  It means you’re changing the future of your family and
                  generations.
                </Text>
                <Text style={styles.regularContentText}>
                  <Text style={styles.underlinedText}>
                    Being first-generation makes me sad.{" "}
                  </Text>
                  When I was in college, I noticed my counterparts could call
                  their families whenever they had problems related to college.
                  My family couldn't help me in that space because I was the
                  first to experience it.
                </Text>
                <Text style={styles.regularContentText}>
                  <Text style={styles.underlinedText}>
                    Being first-gen is full of responsibilities.{" "}
                  </Text>
                  I had a lot of stress when trying to balance school, work, and
              ...
              <View style={styles.regularContentContainer}>
                <Text style={styles.regularContentTextBolded}>
                  Q: How does your first gen identity make you who you are
                  today?
                </Text>
                <Text style={styles.regularContentText}>
                  <Text style={styles.underlinedText}>
                    Being first gen gives me a global perspective, a different
                    point of view on the world and people.{" "}
                  </Text>
                  First-generation experience also gave me an open mind and a
                  hopeful mindset. As a first gen, I would always tell myself to{" "}
                  <Text style={styles.underlinedText}>
            ...
            <View style={styles.individualStep}>
              ...
              <View style={styles.regularContentContainer}>
                ...
                <Text style={styles.regularContentText}>
                  The <Text style={styles.underlinedText}>people </Text>around
                  me and the{" "}
                  <Text style={styles.underlinedText}>
              ...
              <View style={styles.regularContentContainer}>
                <Text style={styles.regularContentTextBolded}>
                  Q: What are your top 3 pieces of advice for our students?
                </Text>
                <Text style={styles.regularContentText}>
                  1. First,{" "}
                  <Text style={styles.underlinedText}>find a community </Text>
                  with people that believe in you.
                </Text>
                <Text style={styles.regularContentText}>
                  2. Second, stay steady and{" "}
                  <Text style={styles.underlinedText}>don't give up. </Text>
                </Text>
                <Text style={styles.regularContentText}>
                  3. Lastly,{" "}
                  <Text style={styles.underlinedText}>care about others. </Text>
                  When you care about other people, you’re creating a community
                  of people who are also going to value you and pour into you.
                </Text>
              </View>
            </View>
          </View>
